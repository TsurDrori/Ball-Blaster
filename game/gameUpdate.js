    ...
    if (bossActive) {
        ...
        for (let i = bosses.length - 1; i >= 0; i--) {
            ...
            if (boss.splitting) {
                ...
                sound.explode();
                floatingTexts.push(new FloatingText(bx, by - 50, 'מתפצל!', '#ffaa44', 24, 'scissors'));
            } else {
        ...
        if (bosses.length === 0) {
            ...
            sound.explode();
            floatingTexts.push(new FloatingText(CANVAS_W / 2, CANVAS_H * 0.42, 'בוס הובס!', '#ffcc00', 34, 'skull'));
        }
